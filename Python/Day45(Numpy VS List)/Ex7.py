...
# b). Order will be preserve in both type.(we can access elements by using index)
...
# a2).We have to creating number of dimensions in numpy array,
#    it is not possible to make Ndimension in list
# a3). List can hold hetrogenous (Multiple data types)
...
# a7). Numpy array are more convienet to use while performing mathematical operations
